...
#
# In Class Exercise
# In the following dataframe, replace the values in col2 that are divisible bu both 2 and 3 with -1
...
crit = (dfx1.loc[:, 'col2'] % 2 == 0) & (dfx1.loc[:, 'col2'] % 3 == 0)
dfx1.loc[crit, 'col2'] = -1
print(dfx1)
